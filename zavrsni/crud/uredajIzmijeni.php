<?php require_once '../skripte/izmijeniScript.php'; ?>
<!DOCTYPE html>
<html lang="hr">
    ...
    <section id="sadrzaj">
        ...
        <div class="prijavaForma">
            <form id="form1" method="post" name="form1"
                action="../skripte/izmijeniScript.php">
                <table>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td><input type="text" id="lokacija" name="lokacija" size="20" maxlength="20"
                                placeholder="lokacija" autofocus="autofocus"></td>
                    </tr>
                    <tr>
                        <td><label for="naziv">Naziv: </label></td>
                        <td><input type="text" id="naziv" name="naziv" size="20" maxlength="26"
                                placeholder="naziv"></td>
                    </tr>
                    <tr>
                        <td><input class="gumb" id="submit" type="submit" name="submit" value=" Obrisi "></td>
                    </tr>
                    <tr>
                        <td><input class="gumb" type="submit" id="izmijeni" name="izmijeni" value="Ažuriraj"></td>
                    </tr>
                </table>
            </form>
        </div>
