...
{  
  ...
  air_Quality = analogRead(MQ135_PIN);
   ...
   String lpg = String(iPPM_LPG);
   String co = String(iPPM_CO);
   String dim = String(iPPM_Smoke);
   String aq = String(air_Quality);

   String data = "lpg="+ lpg + "&&co=" + co + "&&dim=" + dim + "&&kvaliteta_zraka=" + aq + "&&uredaj_id=1\n";
